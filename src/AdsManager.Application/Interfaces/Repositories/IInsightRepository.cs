...
public interface IInsightRepository
{
    ...
    Task<(IReadOnlyCollection<InsightDaily> Items, int Total)> GetPagedAsync(Guid tenantId, InsightListRequest request, CancellationToken cancellationToken = default);
